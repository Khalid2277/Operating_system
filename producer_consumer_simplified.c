/*
 * Simplified Producer-Consumer Implementation
 * Based on Chapter 3 & 7 from Operating Systems Concepts (Silberschatz)
 * 
 * Core synchronization follows the bounded-buffer pattern from:
 * - Chapter 3, pages 29-31 (Bounded Buffer)
 * - Chapter 7, pages 4-6 (Semaphore Solution)
 * 
 * Compilation: gcc -o producer_consumer_simplified producer_consumer_simplified.c -pthread
 * Usage: ./producer_consumer_simplified <num_producers> <num_consumers> <buffer_size>
 */
 ...
 * Follows the producer structure from Chapter 7, page 5
 */
void *producer(void *param) {
    int id = *((int *)param);
    free(param);
 ...
 * Follows the consumer structure from Chapter 7, page 6
 */
void *consumer(void *param) {
    int id = *((int *)param);
    free(param);
...
/**
 * Insert item into buffer
 * Following Chapter 7, page 5 semaphore usage pattern
 */
void insert_item(item next_produced) {
 ...
 * Following Chapter 7, page 6 semaphore usage pattern
 */
item remove_item(void) {
...
int main(int argc, char *argv[]) {
    ...
    /* Initialize semaphores following Chapter 7, page 4 */
